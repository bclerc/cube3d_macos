...
/*   Updated: 2021/03/05 14:32:57 by bclerc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_image_texture(t_cube *cube)
{
	...
	tex = cube->texture;
	mlx = cube->mlx->mlx;
	tex[0]->imgdat = (int *)mlx_get_data_addr(tex[0]->imgptr, &tex[0]->bpp, &tex[0]->size_line, &tex[0]->endian);
	tex[1]->imgdat = (int *)mlx_get_data_addr(tex[1]->imgptr, &tex[1]->bpp, &tex[1]->size_line, &tex[1]->endian);
	tex[2]->imgdat = (int *)mlx_get_data_addr(tex[2]->imgptr, &tex[2]->bpp, &tex[2]->size_line, &tex[2]->endian);
	tex[3]->imgdat = (int *)mlx_get_data_addr(tex[3]->imgptr, &tex[3]->bpp, &tex[3]->size_line, &tex[3]->endian);
	tex[4]->imgdat = (int *)mlx_get_data_addr(tex[4]->imgptr, &tex[4]->bpp, &tex[4]->size_line, &tex[4]->endian);
...
void	load_texture(t_cube *cube)
{
	...
	tex = cube->texture;
	tex[0]->imgptr = mlx_xpm_file_to_image(cube->mlx->mlx, cube->SO, &tex[0]->w, &tex[0]->h);
	...
	tex[4]->imgptr = mlx_xpm_file_to_image(cube->mlx->mlx, cube->SPRITE, &tex[4]->w, &tex[4]->h);	
